...
grid_type = "grid_0D_isotropic"       -- grid geometry. Must match grid geometry in model file if used  
rho = 1e12
T   = 10
Ye  = 0.15
model_file  =  "neutron_star.mod"  -- model file. "custom" --> use hard coded model
nulib_table = "../../external/tables/NuLib_LS220_rho100_temp60_ye40_ng24_ns3_Itemp10_Ieta10_version1.0_20140629.h5" --"../../external/tables/NuLib_LS220_rho100_temp60_ye40_ng24_ns3_Itemp10_Ieta10_version1.0_20140629.h5" -- NuLib opacity/emissivity table
write_zones_every   = 1
write_rays_every    = -1
