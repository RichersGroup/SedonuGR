...
model_file  =  "shell.mod"  -- model file. "custom" --> use hard coded model
nulib_table = "/data/tables/NuLib/NuLib_HShen_noscat.h5" -- NuLib opacity/emissivity table
write_zones_every   = 5
write_rays_every    = -1
...
T_core = TEMP_HERE                      -- core temperature (K) (10 MeV)
core_nue_chem_pot = MUNU_HERE              -- chempot of Ye=0.167031, T=10MeV according to LS220
