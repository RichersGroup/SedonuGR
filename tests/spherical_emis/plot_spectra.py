...
plt.plot(xgrid_shifted,theory0, 'g', label=r"$\nu_e$ GR")
plt.plot(nu_grid,data0, 'go', label=r"$\nu_e$ Sedonu")
plt.plot(xgrid,theory1, 'b--', label=r"$\bar{\nu}_e$ Newtonian")
plt.plot(xgrid_shifted,theory1, 'b', label=r"$\bar{\nu}_e$ GR")
