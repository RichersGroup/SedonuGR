...
plot pi*4.*pi*r*r*x*x*x*h/c/c*1/(exp(h*x/(k_b*T))+1.), './spectrum_species0_00001.dat' using 1:2
set output

set term pdf
set output "compare_spectrum_1.pdf"
set title "Electron Anti-Neutrinos"
plot 4.*pi*pi*r*r*x*x*x*h/c/c*1/(exp(h*x/(k_b*T))+1.), './spectrum_species1_00001.dat' using 1:2
set output
