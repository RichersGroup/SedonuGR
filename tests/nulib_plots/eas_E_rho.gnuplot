...
set xtics out
set ytics out
filename = "./eas_E_rho.dat"
set title "`head -n1 ./eas_E_rho.dat`"
set xlabel "Neutrino Energy (MeV)"
set y2label "Colors: log10[rho(g/cm^3)]"
set key off
