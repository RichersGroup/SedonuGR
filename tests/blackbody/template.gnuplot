...
plot 'results.dat'   u 3:((abs($4-TEMP_HERE)/$4<1e-4)&&(abs($5-YE_HERE)/$5<1e-4)?$19:1/0)     title "Sedonu"
...
plot 'results.dat'   u 4:((abs($3-RHO_HERE)/$3<1e-4)&&(abs($5-YE_HERE)/$5<1e-4)?$19:1/0)     title "Sedonu"
...
plot 'results.dat'   u 5:((abs($4-TEMP_HERE)/$4<1e-4)&&(abs($3-RHO_HERE)/$3<1e-4)?$19:1/0)     title "Sedonu"
