...
axes[0].loglog(r, edens_new[0],'b--',label="NEW")
axes[0].loglog(r, edens_new[1],'r--')
axes[0].loglog(r, edens_new[2],'g--')
axes[0].set_ylabel("Energy Density (erg/ccm)")
axes[0].legend()
passing = passing and normalized_error(edens_old/edens_old, edens_new/edens_old)
...
axes[2].semilogx(r, fluxfac_old[0],'b-')
axes[2].semilogx(r, fluxfac_old[1],'r-')
axes[2].semilogx(r, fluxfac_old[2],'g-')
...
passing = passing and normalized_error(fluxfac_old, fluxfac_new)
...
axes[4].semilogx(r, prrfac_old[0],'b-')
axes[4].semilogx(r, prrfac_old[1],'r-')
axes[4].semilogx(r, prrfac_old[2],'g-')
...
passing = passing and normalized_error(prrfac_old, prrfac_new)
...
axes[1].semilogx(r, avge_old[0],'b-')
axes[1].semilogx(r, avge_old[1],'r-')
axes[1].semilogx(r, avge_old[2],'g-')
axes[1].semilogx(r, avge_new[0],'b--')
axes[1].semilogx(r, avge_new[1],'r--')
axes[1].semilogx(r, avge_new[2],'g--')
axes[1].set_ylabel("Average Energy (MeV)")
passing = passing and normalized_error(avge_old/avge_old, avge_new/avge_old)
