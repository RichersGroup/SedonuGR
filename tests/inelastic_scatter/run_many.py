...
# INPUTS
tolerance = 0.05
eosfile   = "/panfs/ds08/sxs/scurtis/EOS/Hempel_SFHoEOS_rho222_temp180_ye60_version_1.1_20120817.h5" #ignored if compiled for helmholtz eos
...
string = "mpirun -np 1 ../../exe/inelastic_scattering_test inelastic_scatter_kernel.lua " + \
