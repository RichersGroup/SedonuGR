...
program make_table_example
  ...
  integer :: mytable_number_groups = 48

  !EOS table
  character*200 :: eos_filename = "/data/tables/EOS/LS220.h5" !from stellarcollapse.org
  ...
  final_table_size_temp = 130
  
  final_Itable_size_temp = 0
  final_Itable_size_eta = 0
  final_Itable_size_inE = 0 !mytable_number_groups

  base="NuLib_Helmholtz"
  vnum="1.0"
  ...
  bin_bottom(2) = 0.5d0 !MeV
  bin_bottom(3) = bin_bottom(2)+mindx
  bin_bottom(number_groups) = 200.0d0
